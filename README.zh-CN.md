...
[![Chrome Web Store](https://img.shields.io/badge/Chrome-应用商店-green?style=flat&logo=google-chrome)](https://chromewebstore.google.com/detail/select-ai-ai%E5%88%92%E8%AF%8D%E8%A7%A3%E9%87%8A/ehcjdmkcnjniaofflhghckpgmjmbgkjh) [![Edge 应用商店](https://img.shields.io/badge/Edge-应用商店-blue?style=flat&logo=microsoftedge)](https://microsoftedge.microsoft.com/addons/detail/select-ai-explain-tra/ihmkejknobkglabjodamfigdhafohcde) [![Firefox 应用商店](https://img.shields.io/badge/Firefox-应用商店-orange?style=flat&logo=firefox)](https://addons.mozilla.org/en-US/firefox/addon/select-ai-explain-translate/) [![Website](https://img.shields.io/badge/官网-select--ai.cn-blue?style=flat)](https://select-ai.cn) ![TypeScript](https://img.shields.io/badge/TypeScript-3178C6?style=flat&logo=typescript) [![Version](https://img.shields.io/badge/version-v0.21.0-8338ec?style=flat)](./CHANGELOG.md) [![更新日志](https://img.shields.io/badge/更新日志-查看-orange?style=flat)](./CHANGELOG.md) [![English README](https://img.shields.io/badge/English-README-gray?style=flat)](./README.md)
...
| 提供商 | 默认模型 | 格式 |
|--------|----------|------|
| **解语**（默认） | deepseek-flash（DeepSeek V4.1 Flash） | OpenAI |
